          ...
          <Col xl="12">
            <Card>
              ...
              <CardBody>
                <div className="lead">
                  <p className="text-muted ">
                    <Trans>The Apollo comes with tuned preset values (above), which offer a good range of operating modes. By selecting custom you risk damaging your device and FutureBit will not be responsible for any or all damage caused by over-clocking or over-volting</Trans>
                  </p>
                </div>
                {
                minerMode === 'custom'
